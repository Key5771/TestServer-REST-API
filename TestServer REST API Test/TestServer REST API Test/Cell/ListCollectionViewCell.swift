...
extension ListCollectionViewCell: UIGestureRecognizerDelegate {
    override func layoutSubviews() {
        ...
        if pan.state == UIGestureRecognizer.State.changed {
            ...
            self.deleteLabel2.frame = CGRect(x: p.x + deleteLabel2.frame.size.width, y: 0, width: 100, height: height)
        }
    }
